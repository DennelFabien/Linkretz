		...
		<section>
			<div class="sec">
            	<?php
					...
					try {
						$lesEnregs=$bdd->query("SELECT nom, prenom, libelle FROM employe JOIN fonction ON idfonction = fonction.id;");
						...
						// on lit le tableau retourné et pour chaque enregistrement, on affiche le nom et la description
                     	echo'<table>
                        	...
                        	foreach ($lesEnregs as $enreg) {
                            	echo "<tr><td>$enreg->nom</td><td>$enreg->prenom</td><td>$enreg->libelle</td><td><a href='employe_modifier.php'>
