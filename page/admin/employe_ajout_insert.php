...
if (count($_POST) != 0) {
?>
    <?php include '../../include/employe_controle_saisie.php'; ?>
...
if ($msg == "")
    {
        ...
        // on génère le compte composé du nom suivi du premier caractères du prénom
    ...
    try {
        ...
        if ($req->rowCount() == 0) {
              echo("Erreur grave :L'employé n’a pas été enregistré.") ;
            } else {
             echo("L'employé a été enregistré.") ;
            }												
