            	...
            	<input type="text" name="txt_nom" id="nom" placeholder="Saississez votre nom " value="<?php echo $txt_nom;?>" required />

				<label for="prenom">Prénom  </label>
            	<input type="text" name="txt_prenom" id="prenom" placeholder="Saississez votre prénom "value="<?php echo $txt_prenom;?>" required />

            	<label for="tel">Téléphone  </label>
            	<input type="tel" name="txt_tel" id="teleph" pattern=^(?:0|\(?\+33\)?\s?|0033\s?)[1-79](?:[\.\-\s]?\d\d){4}$ placeholder="Saississez votre téléphone " value="<?php echo $txt_tel;?>"/>
            	<br><br>
                ...
                if ($rbt_profil == 'A'){
                    echo "<input type='radio' checked name = 'rbt_profil' id = 'admin' value='admnistrateur'>Administrateur";
                } else {
